...
const Footer = () => {
  ...
  return(
    <div>
    <footer className="footer py-8 grid grid-cols-3 items-center justify-center border-t-4 gap-5 bg-indigo-900 border-gray-300 ">
        <div className="text-center p-5 md:text-star">
          <Link to="/">
            <img className="w-[130px]" src={logo} alt="logo" />
          </Link>
          <p
          className="max-w-md mx-auto mt-4 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-left"
        >
        ...
        <p
          className="max-w-md mx-auto mt-6 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-left"
        >
        ...
        <div className="w-[95px] relative">
          ...
          <p
          className="max-w-md mx-auto mt-2 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-centre"
        >
          Benefits
        </p>
        </div>
      ...
      <div className="sm:flex sm:items-center mt-10">
        <h3 className="text-sm text-white sm:text-center dark:text-gray-400 pr-5">Follow us on
        </h3>
...
<p className="max-w-md mx-auto mt-20 leading-relaxed text-center text-white sm:max-w-xs sm:mx-0 sm:text-left">
         @ Showcase 2023. All Rights Reserved
        </p>
        </div>
        <div className="text-center md:text-start place-items-center md:place-items-start">
          <ul className="mt-8 space-y-5 text-sm  ">
            <li>
              <a
                className="flex items-centre justify-center sm:justify-start gap-1 group"
                href="/"
              >
                <svg
